		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-8">
				<div class="posts-area">
					<h2 class="post-wrapper-title"> main posts  </h2>
					<div class="content-wrapper">
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="main-post">
									<div class="img-box">
										<img src="<?php echo get_template_directory_uri()?>/assets/images/ui/art-slide-1.jpg" alt="post" class="img-responsive">
									</div>
									...
									<div class="writer-info">
										<ul>
											<li> <img src="images/pen.png" alt="icon"> <span> <a href="profile.html"> Hossam Hilal </a> </span>  </li>
							...
							<div class="col-xs-12 col-sm-6">
								<div class="main-post">
									<div class="img-box">
										<img src="<?php echo get_template_directory_uri()?>/assets/images/ui/art-slide-2.jpg" alt="post" class="img-responsive">
									</div>
									<h3> <a href="post-page.html"> Headline of Tobic Headline of Tobic  </a> </h3>
									<p> Aenean eleifend ante maecenas pulvinar montes lorem et pede dis dolor pretium donec dictum. Vici consequat justo enim.… </p>
									<div class="writer-info">
			...
			<div class="col-xs-12 col-sm-12 col-md-4">
				<div class="posts-area">
					<h2 class="post-wrapper-title"> side posts  </h2>
					<div class="content-wrapper">
						<div class="side-post">
							<div class="img-box">
								<img src="<?php echo get_template_directory_uri()?>/assets/images/ui/art-1.jpg" alt="post" class="img-responsive">
						...
						<div class="side-post">
							<div class="img-box">
								<img src="<?php echo get_template_directory_uri()?>/assets/images/ui/art-2.jpg" alt="post" class="img-responsive">
								<div class="overlay"> <i class="fa fa-video-camera" aria-hidden="true"></i> </div>
							</div>
							<div class="data">
								<h3> <a href="post-page.html"> Headline of Tobic Headline of Tobic  </a> </h3>
								<div class="writer-info">
						...
						<div class="side-post">
							<div class="img-box">
								<img src="<?php echo get_template_directory_uri()?>/assets/images/ui/art-3.jpg" alt="post" class="img-responsive">
								<div class="overlay"> <i class="fa fa-futbol-o" aria-hidden="true"></i> </div>
							</div>
							<div class="data">
								<h3> <a href="post-page.html"> Headline of Tobic Headline of Tobic  </a> </h3>
								<div class="writer-info">
						...
						<div class="side-post">
							<div class="img-box">
								<img src="<?php echo get_template_directory_uri()?>/assets/images/ui/art-slide-2.jpg" alt="post" class="img-responsive">
								<div class="overlay"> <i class="fa icofont-fire-burn" aria-hidden="true"></i> </div>
							</div>
							<div class="data">
								<h3> <a href="post-page.html"> Headline of Tobic Headline of Tobic  </a> </h3>
								<div class="writer-info">
...
<!-- POSTS SMALL AND SIDE  -->
<div class="posts-wrapper">
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-8">
				<div class="posts-area">
					<h2 class="post-wrapper-title"> small posts  </h2>
					<div class="content-wrapper">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
								<div class="small-post">
									<div class="img-box">
										<img src="<?php echo get_template_directory_uri()?>/assets/images/ui/art-slide-3.jpg" alt="post" class="img-responsive">
									</div>
									<h3> <a href="post-page.html"> Headline of Tobic Headline of Tobic  </a> </h3>
								</div>
							</div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="individual-post">
                            ...
                            <div class="data">
                                ...
                                <p> Aenean eleifend ante maecenas pulvinar montes lorem et pede dis dolor pretium donec dictum. Vici consequat justo enim pulvinar montes lorem et pede dis dolor pretium donec dictum. Vici consequat justo enim.… </p>
