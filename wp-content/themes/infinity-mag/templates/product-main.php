...
<div <?php post_class( 'main-product' ); ?>>
    ...
    <div class="prod-footer">
		...
		echo apply_filters( 'woocommerce_loop_add_to_cart_link',
			sprintf( '<a href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="add-to-cart button dw-add-to-cart %s %s product_type_%s"%s><img src="%s" alt="cart" class="img-responsive"></a>',
