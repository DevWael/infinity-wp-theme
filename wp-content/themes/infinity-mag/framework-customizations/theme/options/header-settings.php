			...
			'style'         => array(
				...
				'options' => array(
					'header_types' => array(
						...
						'choices' => array(
							'header-one'   => esc_html__( 'Header style 1', 'dw' ),
							'header-two'   => esc_html__( 'Header style 2', 'dw' ),
							'header-three' => esc_html__( 'Header style 3', 'dw' ),
							'header-four'  => esc_html__( 'Header style 4', 'dw' ),
						),
						'inline' => true,
					),
					'sticky_nav'   => array(
