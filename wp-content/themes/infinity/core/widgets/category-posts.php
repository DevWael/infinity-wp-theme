 ...
 */
class dw_category_posts extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			DW_NAME . esc_html__( ' Category posts', 'dw' ), // Name
			array( 'description' => esc_html__( 'add posts from specified category', 'dw' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'category' ); ?>"><?php esc_html_e( 'Select categories :', 'dw' );
				?></label>
