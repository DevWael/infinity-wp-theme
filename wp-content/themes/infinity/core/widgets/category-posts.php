 ...
 */
class window_mag_category_posts extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'window_category_posts', // Base ID
			WINDOW_MAG_NAME . esc_html__( ' Category posts', 'window-mag' ), // Name
			array( 'description' => esc_html__( 'add posts from specified category', 'window-mag' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'category' ); ?>"><?php esc_html_e( 'Select categories :', 'window-mag' );
				?></label>
