 ...
 */
class window_mag_random_posts extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			WINDOW_MAG_NAME . esc_html__( ' Random posts', 'window-mag' ), // Name
			array( 'description' => esc_html__( 'add random posts widget', 'window-mag' ), ) // Args
		);
	}
