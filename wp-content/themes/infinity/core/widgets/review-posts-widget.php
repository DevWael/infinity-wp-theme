 ...
 */
class window_mag_review_posts extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			WINDOW_MAG_NAME . esc_html__( ' Review posts', 'window-mag' ), // Name
			array( 'description' => esc_html__( 'add review posts widget', 'window-mag' ), ) // Args
		);
	}
