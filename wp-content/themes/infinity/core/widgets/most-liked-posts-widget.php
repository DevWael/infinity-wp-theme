 ...
 */
class window_mag_most_liked extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'window_most_liked', // Base ID
			WINDOW_MAG_NAME . esc_html__( ' Most liked posts', 'window-mag' ), // Name
			array( 'description' => esc_html__( 'add most liked posts widget', 'window-mag' ), ) // Args
		);
	}
