...
$query_type      = window_mag_get_setting( 'top_posts_switch/on/top_posts_query/type' );
$show_mobile     = window_mag_get_setting( 'top_posts_switch/on/visible_mobile' );
$top_posts_count = window_mag_get_setting( 'top_posts_switch/on/posts_count' );
$cat_ids         = window_mag_get_setting( 'top_posts_switch/on/top_posts_query/category/cat_select' );
$tags_ids        = window_mag_get_setting( 'top_posts_switch/on/top_posts_query/tag/tag_select' );
$author_id       = window_mag_get_setting( 'top_posts_switch/on/top_posts_query/author/author_select' );
if ( 'off' === $show_mobile ) {
