<div class="share-box">
	<ul class="share-icons">
		...
		<?php endif; ?>
		<?php if ( 'on' === dw_get_setting( 'share_stumble' ) or ! function_exists( 'fw_get_db_settings_option' ) ): ?>
			<li>
				<a href="http://www.stumbleupon.com/submit?url=<?php echo esc_url( get_permalink() ); ?>&amp;title=<?php echo esc_attr( $encoded_title ); ?>"
				   ...
				   onclick="javascript:void window.open(this.href,'Stumbleupon-share', 'width=640,height=680');return false;">
					<i class="fa fa-stumbleupon"></i><span><?php esc_html_e( 'Stumbleupon', 'dw' ); ?></span>
				</a>
			</li>
		<?php endif; ?>
	</ul>
